...
export const SITE_URL = (import.meta.env.PUBLIC_SITE_URL || 'https://wheretheywent.pages.dev').replace(
  /\/$/,
  '',
);
...
export const REPO_URL = 'https://github.com/wheretheywent/wheretheywent';
